class HelpTopic {
  ...
  HelpTopic({required this.title, required this.content});
}
...
class HelpCategory {
  ...
  HelpCategory({required this.title, required this.topicId, required this.subTopics});
}

final Map<String, HelpTopic> helpContent = {
  // Getting Started
...
Google "[stock/index name] yahoo finance" and use the symbol shown in the page.""",
  ...
  'understanding-charts': HelpTopic(
